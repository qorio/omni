...
func (this *ShortyEndPoint) ReportInstallOnOrganicAppLaunch(resp http.ResponseWriter, req *http.Request) {
	...
	visits, cookied, lastViewed, userId := processCookies(cookies, "")
	...
	*/
	...
	glog.Infoln("Browser-switch", "lastViewed=", lastViewed, "sc=", sc, "userId=", userId, "visits=", visits, "cookied=", cookied)
